...
- 💼 [LinkedIn](https://www.linkedin.com/in/carlosdortizcs) 
...
| Course | Description |
|:-------|:-------------|
| **Modern AI** | Neural networks, deep learning, reinforcement learning, GANs, and CNNs — emphasizing modern architectures and applications. |
| **Integrated Problem Solving for AI** | Applying ML, optimization, and human-AI collaboration frameworks to real-world problems. Learned system design principles that balance autonomous and human-driven tasks for safer and more efficient AI outcomes. |
| **Data Mining** | Discovering hidden structures and patterns in large datasets using Python and statistical inference. |
| **Database Management** | SQL design, relational schemas, data normalization, and performance optimization for scalable applications. |
...
| Course | Description |
|:-------|:-------------|
| **Ethical Hacking (UTEP & Udemy)** | Penetration testing and security evaluation methodologies applied to network and web systems. |
| **Computer Security** | Cryptography, authentication, system hardening, and secure communication techniques. |
